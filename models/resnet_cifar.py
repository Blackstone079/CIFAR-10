...
class ResNet(nn.Module):
    def __init__(self, blocks_per_stage, base_width=16, num_classes=10):
        super().__init__()
        ...
        self.ch_current = c1
        self.layer1 = self._make_stage(c1, n_blocks=blocks_per_stage, stride=1)
        self.layer2 = self._make_stage(c2, n_blocks=blocks_per_stage, stride=2)
        self.layer3 = self._make_stage(c3, n_blocks=blocks_per_stage, stride=2)
